      ...
      <div className="techGauche">
        ...
        <div className="techDiv">
          <div className="techBubbles">
            <Link className={idActuelle === 0 ? "active" : ""} to="/react-space-router/technology/0">1</Link>
            <Link className={idActuelle === 1 ? "active" : ""} to="/react-space-router/technology/1">2</Link>
            <Link className={idActuelle === 2 ? "active" : ""} to="/react-space-router/technology/2">3</Link>
          </div>
